...
insert into public.personas (slug, name, bio_short, bio_long, primary_domain, domain_lens, approved_categories, writing_voice_json, eeat_signals_json, soul_json, avatar_url, is_active, created_at, updated_at)
values (
  $bt$cole-merritt$bt$,
  $bt$Cole Merritt$bt$,
...
Cole Merritt is an editorial persona representing the early-stage founder perspective. Content is based on real operator experience and independent research.$bt$,
  ...
  $bt$https://api.dicebear.com/9.x/notionists/svg?seed=cole-merritt&backgroundColor=b6e3f4&radius=50$bt$,
  true,
  now(),
  now()
)
...
Alex Strand is an editorial persona representing the FIRE-focused entrepreneur perspective. Content is based on independent financial research and operator experience.$bt$,
  ...
  $bt$https://api.dicebear.com/9.x/notionists/svg?seed=alex-strand&backgroundColor=c0aede&radius=50$bt$,
  true,
  now(),
  now()
)
...
Casey Park is an editorial persona representing the portfolio entrepreneur perspective. Content is based on real product-building experience and independent research.$bt$,
  ...
  $bt$https://api.dicebear.com/9.x/notionists/svg?seed=casey-park&backgroundColor=d1d4f9&radius=50$bt$,
  true,
  now(),
  now()
)
