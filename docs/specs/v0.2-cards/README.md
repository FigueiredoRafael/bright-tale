...
- `ready ⚙️` — bloqueado em decisão pendente (ver doc-fonte)
...
|---|---|---|---|---:|
| [M-001](./M-001-stripe-wiring.md) | Stripe wiring (cartão + Pix BR + Apple Pay) | ready ⚙️ | M-000 | 5d |
| [M-002](./M-002-credits-model.md) | Credits model in DB + uso extra com cap | ready ⚙️ | M-001 | 4d |
| [M-003](./M-003-free-tier.md) | Free tier setup | ready ⚙️ | M-002 | 1d |
...
| ID | Título | Status | Depends | Estimate |
|---|---|---|---|---:|
| [M-005](./M-005-notifications.md) | Notification system (Realtime + email + bell) | ready ⚙️ | M-000 | 5d |
| [M-006](./M-006-support-chatbot.md) | Support chatbot (FAQ + refunds + plan changes) | ready ⚙️ | M-005, M-007 | 6d |
| [M-007](./M-007-auto-refund.md) | Auto-refund + anti-fraud safeguards | ready ⚙️ | M-001 | 4d |
| [M-008](./M-008-support-escalation.md) | Support escalation + admin queue (SLA + priority) | ready ⚙️ | M-005, M-006 | 5d |
| [M-009](./M-009-post-sale.md) | Post-sale lifecycle (welcome / check-in / NPS) | ready ⚙️ | M-005 | 3d |
| [M-010](./M-010-affiliate-integration.md) | Affiliate lifecycle notifications | ready ⚙️ | M-005, M-008 | 2d |
...
| [M-014](./M-014-coupons.md) | Coupons (all types) | ready ⚙️ | M-001 | 4d |
| [M-015](./M-015-finance-dashboard.md) | Finance dashboard (revenue × cost × margin) | ready ⚙️ | M-001, M-002 | 5d |
...
| [M-018](./M-018-admin-redesign.md) | Admin redesign (layout + user mgmt) | ready ⚙️ | — | 5d |
| [M-019](./M-019-sales-page.md) | Sales page redo (apps/web + apps/app upgrade) | ready ⚙️ | — | 4d |
...
3. If `ready ⚙️`, resolve them in the roadmap doc first
