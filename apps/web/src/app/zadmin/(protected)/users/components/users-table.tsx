    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-8 z-20 w-44 bg-white dark:bg-dash-card border border-slate-200 dark:border-dash-border rounded-xl shadow-lg py-1 text-sm">
            <button
              type="button"
              onClick={() => { setOpen(false); onEdit(); }}
              className="w-full flex items-center gap-2.5 px-3 py-2 text-slate-700 dark:text-v-primary hover:bg-slate-50 dark:hover:bg-dash-surface transition-colors text-left"
            >
            ...
            <div className="my-1 border-t border-slate-100 dark:border-dash-border" />
            <button
              type="button"
              onClick={() => { setOpen(false); onDelete(); }}
              className="w-full flex items-center gap-2.5 px-3 py-2 text-red-600 dark:text-v-red hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors text-left"
            >
