/**
 * Slice 14.4 — DraftEngine dual-path migration tests (TDD red→green→refactor).
 *
 * Slices covered:
 ...
 *   3. Reads stageResults.draft from ProjectContextProvider
...
vi.mock('@/components/preview/DraftViewer', () => ({
  DraftViewer: () => <div data-testid="draft-viewer" />,
}));
...
const PROJECT_ID = 'proj-draft-test';
const CHANNEL_ID = 'ch-dr';
...
describe('DraftEngine — slice 1: renders under ProjectContextProvider (no actor)', () => {
...
describe('DraftEngine — slice 2: reads from ProjectContextProvider', () => {
...
describe('DraftEngine — slice 3: draft result from context', () => {
  it('renders without crashing when stageResults.draft exists in context', async () => {
