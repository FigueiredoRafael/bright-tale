  ...
  sections: {
    header: {
      ...
      principles: [
        ...
        'If `production_params.target_duration_minutes` is provided: scale `teleprompter_script` to that duration at ~150 words/minute. Set `content_warning` instead of padding when material is insufficient.',
    ...
    inputSchema: {
      ...
      fields: [
        ...
        obj('production_params', 'Optional production controls', [
          num('target_duration_minutes', 'Target video duration in minutes. Agent scales teleprompter_script to ~150 words/minute.', false),
        ], false),
      ],
    },
    outputSchema: {
